        ...
        <div className="lg:hidden bg-black/90 backdrop-blur-sm border-b border-white/10 p-8 flex flex-col gap-8 animate-in fade-in slide-in-from-top-4">
          ...
          <div className="pt-6 border-t border-white/10">
            <ConnectButton 
              ...
              theme="dark"
              connectButton={{
                className: "!bg-gold/10 !border !border-gold/30 !text-gold !rounded-full !px-6 !py-3 !text-[10px] !uppercase !tracking-widest hover:!bg-gold/20 transition-all w-full",
                label: "Connect Identity"
              }}
            />
          </div>
